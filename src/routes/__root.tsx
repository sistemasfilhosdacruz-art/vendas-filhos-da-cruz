...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Loja FDC — Vendas & Fiado" },
      { name: "description", content: "PDV e controle de fiado para a loja do retiro Loja FDC." },
      { name: "theme-color", content: "#467B8D" },
      { property: "og:title", content: "Loja FDC — Vendas & Fiado" },
      { property: "og:description", content: "PDV e controle de fiado para a loja do retiro Loja FDC." },
      { property: "og:type", content: "website" },
      { name: "twitter:title", content: "Loja FDC — Vendas & Fiado" },
      { name: "twitter:description", content: "PDV e controle de fiado para a loja do retiro Loja FDC." },
